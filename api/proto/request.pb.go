...
type FILTER_VALUE_TYPE int32

const (
	FILTER_VALUE_TYPE_FILTER_VALUE_UNKNOWN FILTER_VALUE_TYPE = 0
	FILTER_VALUE_TYPE_FILTER_VALUE_STRING  FILTER_VALUE_TYPE = 1
	FILTER_VALUE_TYPE_FILTER_VALUE_INTEGER FILTER_VALUE_TYPE = 2
	FILTER_VALUE_TYPE_FILTER_VALUE_FLOAT   FILTER_VALUE_TYPE = 3
)

var FILTER_VALUE_TYPE_name = map[int32]string{
	0: "FILTER_VALUE_UNKNOWN",
	1: "FILTER_VALUE_STRING",
	2: "FILTER_VALUE_INTEGER",
	3: "FILTER_VALUE_FLOAT",
}

var FILTER_VALUE_TYPE_value = map[string]int32{
...
func (x FILTER_VALUE_TYPE) String() string {
	return proto.EnumName(FILTER_VALUE_TYPE_name, int32(x))
}

func (FILTER_VALUE_TYPE) EnumDescriptor() ([]byte, []int) {
...
type Filter struct {
	...
	ValueType            FILTER_VALUE_TYPE    `protobuf:"varint,2,opt,name=value_type,json=valueType,proto3,enum=proto.FILTER_VALUE_TYPE" json:"value_type,omitempty"`
	Name                 string               `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`
...
func (m *Filter) GetValueType() FILTER_VALUE_TYPE {
	if m != nil {
		return m.ValueType
	}
	return FILTER_VALUE_TYPE_FILTER_VALUE_UNKNOWN
}
...
type Join struct {
	...
	Key1                 string    `protobuf:"bytes,2,opt,name=key1,proto3" json:"key1,omitempty"`
	Table2               string    `protobuf:"bytes,3,opt,name=table2,proto3" json:"table2,omitempty"`
...
func init() {
	...
	proto.RegisterEnum("proto.FILTER_VALUE_TYPE", FILTER_VALUE_TYPE_name, FILTER_VALUE_TYPE_value)
...
var fileDescriptor_336e959edb61afc4 = []byte{
	...
	,
}
